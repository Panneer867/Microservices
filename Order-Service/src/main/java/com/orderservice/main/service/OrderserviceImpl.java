...
import com.orderservice.main.exception.CustomException;
...
public class OrderserviceImpl implements OrderService {
	...
	@Override
	public OrderResponse getOrderDetails(long orerId) {

		log.info("Get Order Details for orer Id : {}", orerId);

		Order order = orderRepository.findById(orerId).orElseThrow(
				() -> new CustomException("Order not found for the order Id : " + orerId, "NOT_FOUND", 404));
